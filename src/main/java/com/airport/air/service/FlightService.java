...
//
//
//    //Method to find a flight by the Code
//    public Flight findFlightById(int flightId) {
//        Flight flight = jdbcRepository.findById(flightId);
//        return flight;
//    }
//
//
...
//    }
//
//    //Method to filter status of a flight depending on time remaining until departure
//    public static String statusMapper(Flight currFlight) {
//        int z = (int) LocalTime.now().until(currFlight.getFlight_time(), MINUTES);
//        if (z < 30)
//            return Status.BOARDING.name();
//        else if (z < 60)
//            return Status.GATE_OPEN.name();
//        else
